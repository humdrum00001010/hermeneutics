...
`
  ...
  // ../_build/dev/phoenix-colocated/hermeneutics/index.js
  var hooks = {};

  // js/app.js
  var import_topbar = __toESM(require_topbar());
  var csrfToken = document.querySelector("meta[name='csrf-token']").getAttribute("content");
  var extensionPage = window.location.protocol === "chrome-extension:";
  var liveSocket = new LiveSocket2(extensionPage ? "ws://127.0.0.1:4000/live" : "/live", Socket, {
